          ...
          <el-row>
            ...
            <el-col :span="12">
              <el-form-item label="详细地址：" prop="address">
                <el-input v-model="form.address" maxlength="150"></el-input>
              </el-form-item>
            </el-col>
          </el-row>
          <el-row>
            ...
            <el-col :span="12">
              <el-form-item label="备注：" prop="remarks">
                <el-input v-model="form.remark" maxlength="160"></el-input>
              </el-form-item>
            </el-col>
          </el-row>
        </div>
          ...
          <el-row>
            ...
            <el-col :span="12">
              <el-form-item label="Account Name：" prop="accountName">
                <el-input v-model="form.accountName" maxlength="108"></el-input>
              </el-form-item>
            </el-col>
          </el-row>
          <el-row>
            <el-col :span="12">
              <el-form-item label="开户银行：" prop="depositBank">
                <el-input v-model="form.depositBank" maxlength="108"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="Account Address：" prop="accountAddress">
                <el-input v-model="form.accountAddress" maxlength="108"></el-input>
              </el-form-item>
            </el-col>
          </el-row>
          <el-row>
            ...
            <el-col :span="12">
              <el-form-item label="Account Number：" prop="accountNumber">
                <el-input v-model="form.accountNumber" maxlength="108"></el-input>
              </el-form-item>
            </el-col>
          </el-row>
          <el-row>
            ...
            <el-col :span="12">
              <el-form-item label="Bank Detail：" prop="bankDetails">
                <el-input v-model="form.bankDetails" maxlength="108"></el-input>
              </el-form-item>
            </el-col>
          </el-row>
          <el-row>
            <el-col :span="12">
              <el-form-item label="Swift Code：" prop="swiftCode">
                <el-input v-model="form.swiftCode" maxlength="108"></el-input>
              </el-form-item>
            </el-col>
          </el-row>
          <el-row>
            ...
            <el-col :span="12">
              <el-form-item label="BSB：" prop="bsb">
                <el-input v-model="form.bsb" maxlength="108"></el-input>
              </el-form-item>
            </el-col>
          </el-row>
          <el-row>
            ...
            <el-col :span="12" :offset="12">
              <el-form-item label="GSS ABN：" prop="gssAbn">
                <el-input v-model="form.gssAbn" maxlength="108"></el-input>
              </el-form-item>
            </el-col>
          </el-row>
          <el-row>
            <el-col :span="12" :offset="12">
              <el-form-item label="Certifuicate Number：" prop="certifuicaenumber">
                <el-input v-model="form.certifuicaenumber" maxlength="108"></el-input>
              </el-form-item>
            </el-col>
          </el-row>
          <el-row>
...
<script>
  ...
  export default {
    ...
    mounted () {
      ...
      this.operate = this.$route.path === '/router/editPartner' ? 'edit' : 'add'
    ...
    methods: {
      ...
      loadData () {
        ...
        Api.partnerDetail({id: this.$route.query.id}).then((res) => {
          if (res) {
            this.form = res
            this.form.partnerAttachmentReqs = []
            ...
            // 文件上传数据回显
            this.fileListReqs = res.partnerAttachments
            let _this = this
      ...
      addContactItem () {
        let item = {
          ...
          phone: '',
          remarks: '',
          type: '001' // 联系人分类 001:战略合作伙伴联系人 002:客户 003：供应商
        }
        ...
        this.$refs[formName].validate((valid) => {
          if (valid) {
            ...
            if (this.fileListReqs.length > 0) {
              let _this = this
              this.fileListReqs.forEach(function(item){
                _this.form.partnerAttachmentReqs.push({
                  id: item.id? item.id: '',
      ...
      addPartner (tag) {
        ...
        Api.addPartner(this.form).then((res) => {
          if (res) {
            ...
            if (tag === 1) {
              this.$router.push({path: '/router/partnerList'})
            } else {
              // 提交后继续创建
      ...
      updatePartner () {
        ...
        Api.updatePartner(this.form).then((res) => {
          if (res) {
            this.$notify.success({
              title: '提示',
              message: '合作伙伴修改成功'
