          ...
          <el-row>
            <el-col :span="12">
              <el-form-item label="对公账户：" prop="publicAccounts">
                <el-input v-model="form.publicAccounts" maxlength="108"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="12">
             ...
             <template v-if="$route.query.type==0">
              ...
              <template slot-scope="scope">
                ...
                <div v-else-if="header.prop == 'model'">
                  <el-input v-model="scope.row.model" maxlength="20"></el-input>
                </div>
  ...
  export default {
    ...
    methods: {
      ...
      addSupplier (tag) {
        ...
        const type = this.$route.query.type
        params.type = type
        const supplierTypes = this.$route.query.supplierTypes
        params.supplierType = supplierTypes
            ...
            if (tag === 1) {
              if(type==='0'){
                this.$router.push({path: '/router/supplierMaterielList'})
              	...
              	}else if(supplierTypes ==='2'){
              	  this.$router.push({path: '/router/aerialSupplierList'})
              	}
              	else if(supplierTypes === '3'){
              	  this.$router.push({path: '/router/goodsSupplierList'})
              	}
              }else if(type==='2'){
