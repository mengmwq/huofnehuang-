            ...
            <el-table-column v-for="(header, index) in tableHeader" v-if="header.show" :key="index" :prop="header.prop"  :label="header.label" :sortable="header.sortable"
              ...
              <template slot-scope="scope">
                ...
                <div v-else-if="header.prop == 'rechargingAmount'">
                  <el-input-number v-model="scope.row.rechargingAmount" :min="0" @blur="calcPrice(scope.row.rechargingAmount, scope.$index, 'listData', 'rechargingAmount')"></el-input-number>
                </div>
                <div v-else-if="header.prop == 'cashAmount'">
                  <el-input-number v-model="scope.row.cashAmount" :min="0" @blur="calcPrice(scope.row.cashAmount, scope.$index, 'listData', 'cashAmount')"></el-input-number>
                </div>
                <div v-else-if="header.prop == 'amount'">
                  <el-input-number v-model="scope.row.amount" :min="0" @blur="calcAmountPrice(scope.row.amount, scope.$index, 'listData', 'amount')"></el-input-number>
                </div>
