  ...
  <div class="formDetails">
    ...
    <!-- <vue-easy-print  ref="easyPrint" >
            ...
            <template slot-scope="func">
                <PaymentPrint  :getChineseNumber="func.getChineseNumber" :tableDetails="form" :searchQuery="query"></PaymentPrint>
            </template>
        </vue-easy-print> -->
  </div>
</template>
    ...
    methods: {
      ...
      getSummaries(param) {
        ...
        columns.forEach((column, index) => {
          ...
          if (!values.every(value => isNaN(value)) && (column.property =='amount' || column.property =='conversion')){
