  ...
  <div>
    <el-form label-position="right" :model="form" :rules="rules" ref="form" label-width="130px">
          ...
          <el-row v-if="$route.query.tag!='outerWorker'">
            <el-col :span="12" v-if="$route.query.flag!='myApply'">
              <el-form-item label="供应商类型：" prop="supplierType" >
                ...
                <el-select  filterable v-model="form.supplierType" @change="supplierTypeChange()" clearable placeholder="供应商名称" size="medium" style="width: 100%;">
      ...
      <div class="footer m10">
        <el-button type="primary" size="medium" @click="goHref('form')">返  回</el-button>
...
<script>
  ...
  export default {
    ...
    mounted () {
      ...
      this.operate = this.$route.path === '/router/administrationApplyEdit' ? 'edit' : 'add'
      // 项目列表
