          ...
          >
            ...
            <el-table-column v-for="(header, index) in tableHeader" v-if="header.show" :key="index" :prop="header.prop"  :label="header.label" :sortable="header.sortable"
              ...
              <template slot-scope="scope">
                <div v-else-if="header.prop == 'feeTypeName'">
                  <el-input v-model="scope.row.feeTypeName"></el-input>
                </div>
                <div v-else-if="header.prop == 'amount'">
                  <el-input-number v-model="scope.row.amount" :min="0" @blur="calcPrice(scope.row.amount, scope.$index, 'listData', 'amount')"></el-input-number>
                </div>
