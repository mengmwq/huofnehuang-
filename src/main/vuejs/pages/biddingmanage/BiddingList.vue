<template>
  <div>
    ...
    <el-row :gutter="20" class="m10">
      <el-col :span="6">
        <el-button type="primary" size="small" @click="addNewBidPro" v-showBtn data-authorityType="addBiddingPro-btn"
                   icon="el-icon-plus"> 新增投标项目
        </el-button>
      </el-col>
      <el-col :span="18" class="text-right">
        <el-select filterable v-model="query.stateId" clearable placeholder="状态" size="small" @change="loadData(null)"
                   style="width:180px">
        ...
        <el-input size="small" clearable placeholder="时间，采购人，项目名称，项目编号" icon="search" v-model="query.param"
    ...
    >
      ...
      <el-table-column v-for="(header, index) in tableHeader" v-if="header.show" :key="index" :prop="header.prop"
                       :label="header.label" :sortable="header.sortable" :header-align="header.headerAlign"
