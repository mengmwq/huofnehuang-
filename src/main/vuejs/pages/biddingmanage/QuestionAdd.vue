<template>
  <el-dialog
      :title="editForm.id?'编辑问题反馈':'添加问题反馈'"
      ...
      size="tiny" top="12vh" width="50%">
       <el-form label-width="120px" :model="editForm" :rules="rules" ref="editForm" >
        ...
        <el-form-item label="备注：">
            <el-input type="textarea" v-model="editForm.remarks"   autosize show-word-limit maxlength="200"></el-input>
        </el-form-item>
        </el-form>
      ...
      confirm(){
          this.$refs.editForm.validate((valid) => {
            if (valid) {     
                ...
                const fn = editForm.id ?'updateByIdQuestion':'saveQuestion'
