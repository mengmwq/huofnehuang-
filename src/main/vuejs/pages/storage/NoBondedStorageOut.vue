<template>
  <!--添加货物-->
  <el-dialog title="出库操作" :before-close="closeDialog" :visible.sync="isShowDialog" width="60%">
    <el-table
    ...
    confirm(formName) {
      ...
      this.$refs[formName].validate(valid => {
        if (valid) {
          ...
          Api.checkoutNotBonded(params).then(res => {
             this.$notify.success({
                  title: "提示",
                  message: "出库提交成功"
                });
