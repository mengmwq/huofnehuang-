<template>
  <div>
    ...
    <!-- table -->
    <el-table class="page-table" :data="listData"  @sort-change="sortChange"
    ...
    export default {
       ...
       viewUser (item) {
         this.JobDialog= true
          ...
          Api.getCustomerDetailedStatistics(param).then((res) => {
            this.detailed = res
          })
	    },
           getOrgList(){
         ...
         search  (pageNum=1) {
          if(typeof pageNum =='object'){
           ...
           Api.getCustomerStatistics(this.query).then(data => {
