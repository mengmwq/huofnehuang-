        ...
        <el-col :span="4">
          <el-dropdown>
            ...
            <el-dropdown-menu slot="dropdown">
              <router-link v-showBtn data-authorityType="invoiceApply-btn"  :to="{path: '/router/addInvoiceApply', query: {tag: '1'}}" tag="div">
                <el-dropdown-item>发票申请</el-dropdown-item>
              </router-link>
              <router-link v-showBtn data-authorityType="borrowApply-btn" :to="{path: '/router/addPaymentApply', query: {tag: '1'}}" tag="div">
                <el-dropdown-item>付款申请</el-dropdown-item>
              </router-link>
              <router-link v-showBtn data-authorityType="paymentApply-btn"  :to="{path: '/router/addBorrowApply', query: {tag: '1'}}" tag="div">
                <el-dropdown-item>借款申请</el-dropdown-item>
              </router-link>
              <router-link v-showBtn data-authorityType="reimburseApply-btn" :to="{path: '/router/addReimburseApply', query: {tag: '1'}}" tag="div">
                <el-dropdown-item>报销申请</el-dropdown-item>
              </router-link>
              <router-link v-showBtn data-authorityType="travelApply-btn" :to="{path: '/router/addTravelApply', query: {tag: '1'}}" tag="div">
                <el-dropdown-item>差旅报销申请</el-dropdown-item>
              </router-link>
