  ...
  <div>
    ...
    <div>
      ...
      <el-row class="m10">
        <el-col :span="6" class="text-left">
          ...
          <router-link :to="{ path: '/router/addProject', query: {type: 'A'}}"  v-showBtn data-authorityType="createHangCai-btn">
            <el-button type="primary" size="medium">新增航材项目</el-button>
          </router-link>
        </el-col>
        <el-col :span="18" class="text-right" style="float: right;">
          <el-date-picker
            v-if="tabIndex===1"
            style="width: 350px"
            @change="loadData"
          ...
          <template slot-scope="scope">
            <el-dropdown>
              ...
              <el-dropdown-menu slot="dropdown">
                <!--<router-link :to="{path: '/router/editProject', query: {id: scope.row.projectCode}}" tag="div">-->
                <!--<el-dropdown-item>编辑</el-dropdown-item>-->
                <!--</router-link>-->
                <!--<el-dropdown-item>编辑</el-dropdown-item>-->
                <!--v-showBtn data-authorityType="delete-btn"
                v-showBtn data-authorityType="proEstablish-btn"
                v-showBtn data-authorityType="proDiscard-btn"
                v-showBtn data-authorityType="proDone-btn"
                v-showBtn data-authorityType="proProgress-btn"-->
                <el-dropdown-item  @click.native="deleteTask(scope.row)">删除</el-dropdown-item>
                <el-dropdown-item  @click.native="operateTask(scope.row, '005')">项目成立</el-dropdown-item>
                <el-dropdown-item  @click.native="operateTask(scope.row, '011')">项目作废</el-dropdown-item>
                <el-dropdown-item  @click.native="operateTask(scope.row, '012')">项目完结</el-dropdown-item>
                <el-dropdown-item  @click.native="operateTask(scope.row, 'progress')">项目进度</el-dropdown-item>
              </el-dropdown-menu>
            </el-dropdown>
          </template>
        </el-table-column>
    ...
    <el-dialog
      :close-on-click-modal="canClick"
            :title="editForm.stateId === '001'? '项目作废': '项目进度'"
    ...
    methods: {
      ...
      sureUpdate () {
        ...
        let param = {
          ...
          stateId: this.editForm.projectCode
        }
