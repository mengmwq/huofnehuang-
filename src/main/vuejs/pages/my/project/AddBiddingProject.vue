      ...
      <div class="print-data">
        <div >
          <el-row>
            ...
            { required: true, message: '请选择报名方式', trigger: 'chnage' },
             ...
             <el-col :span="8">
              <el-form-item label="预算金额：" prop="bidProjectReq.budgetAmount" >
                <el-input v-model="form.bidProjectReq.budgetAmount" placeholder="以数字填充，保留两位小数"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="8">
            ...
            <el-row>
            <el-col :span="24">
              <el-form-item label="项目内容：" class="hiddenToolbar">
                <quill-editor 
                  v-model="form.bidProjectReq.projectContet" 
                  ref="myQuillEditor" 
            ...
            <el-col :span="8">
                ...
                <el-input v-model="form.bidProjectReq.agentCompany" placeholder="请输入代理单位"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="8">
            ...
            { required: false, message: '请输入代理单位联系人', trigger: 'change' },
                ...
                <el-input v-model="form.bidProjectReq.agent" placeholder="请输入代理单位联系人"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="8">
        ...
        <!-- <div  style="padding: 10px;">
          <el-row>
            ...
            { required: true, message: '请选择审批流程', trigger: 'change' },
                ...
                <el-select v-model="form.bidProjectReq.approvalProcessId" filterable clearable placeholder="请选择审批流程" size="medium" style="width:100%">
