<template>
  <div>
    ...
    <!--收支明细 -->
    <ProjectFinanceSummary v-if="tabIndex==1"></ProjectFinanceSummary>
    <!--账单确认-->
    <ProjectFinanceCheckBill v-if="tabIndex==2" :stateId="stateId"></ProjectFinanceCheckBill>
    <!--收入确认-->
    <ProjectRevenueBill v-if="tabIndex==3" :stateId="stateId"></ProjectRevenueBill>
    <!--支出确认-->
    <ProjectExpenditureBill v-if="tabIndex==4" :stateId="stateId"></ProjectExpenditureBill>
         <!--项目收支打印-->
...
<script>
  ...
  import ProjectFinanceSelf from './ProjectFinanceSelf'
  ...
  export default {
     ...
     */
      loadData() {
        ...
        const params = {
          relationId: this.$route.query.projectCode
        }
