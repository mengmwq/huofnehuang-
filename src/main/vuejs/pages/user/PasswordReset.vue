<template>
  <el-dialog
      ...
      <el-radio-group v-model="radioVal" class="radio-group">
        ...
        <el-input v-model.trim="newPassword"  v-if="radioVal==1" placeholder="最少6位，不含空格" class="new-password" :maxlength="12"></el-input>
     </el-radio-group>
    ...
    methods: {
      ...
      save(newPassword){
        ...
        let params = {
            ...
            realname:editForm.name?editForm.name:'',
            password:newPassword   //临时用 password
        }
