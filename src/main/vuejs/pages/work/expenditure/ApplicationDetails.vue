<template>
  <div>
    <el-form label-position="right" :model="form" :rules="rules" ref="form" label-width="130px">
          ...
          <el-row>
            <el-col :span="12">
              <el-form-item label="供应商类型：">
                  <span v-if="form.attached && form.attached.SupplierType"> {{form.attached.SupplierType[form.supplierType].cnInfo}}</span>
            ...
            <el-col :span="12"  v-if="form.depositBank">
              <el-form-item label="开户银行：">
                {{form.depositBank}}
              </el-form-item>
            </el-col>
            <el-col :span="12" v-if="form.bankCode">
      ...
      <!-- 打印内容结束 -->
      <div class="tar pd20">
        <el-button type="default" size="medium" @click="goHref('form')">返回</el-button>
       <el-button type="primary" size="medium" @click="handlePrint">打印</el-button>
      </div>
      
    </el-form>
    <div id="printExpenditure" v-if="isShowPrint">
       <PrintExpenditure  
              :form="form"   
              :id="$route.query.id" :targetId="$route.query.applyId" :approvalInfo="approvalInfo"></PrintExpenditure> 
      </div>
    <ImgPreview
    :pictures="pictures"
...
<script>
  ...
  import Api from '@/api/index'
    import PrintExpenditure from './PrintExpenditure'
  export default {
