<template>
  <div class="mt10">
    ...
    <el-row :gutter="20"  v-if="flag==='list'">
      <el-col :span="10">
        <el-button type="primary" size="small" @click="newPayApply" data-authorityType="add-btn">出险记录</el-button>
    ...
    >
     <el-table-column v-if="flag==='list'" type="selection" width="55"></el-table-column>
      ...
      :prop="header.prop"  :label="header.label" :sortable="header.sortable" :fixed="header.fixed"
        ...
        <template slot-scope="scope">
          ...
          <div v-else-if="header.prop === 'registrationNumber'">
            <router-link :to="{path: '/router/insuranceRecordApplicationDetails', query: {id: scope.row.id}}">
      ...
      <el-table-column label="操作" width="80" fixed="right">
        <template slot-scope="scope">
          <router-link v-if="flag==='list'" :to="{path: '/router/editInsuranceRecordApplication', query: {id: scope.row.id}}"  data-authorityType="edit-btn">
            <el-button type="primary" size="mini">编辑</el-button>
          </router-link>
          <router-link v-if="flag==='details'" :to="{path: '/router/insuranceRecordApplicationDetails', query: {id: scope.row.id}}"  data-authorityType="edit-btn">
    ...
    methods: {
      ...
      deleteItem(){
        ...
        this.$confirm(`确认删除车牌号【${nameStr}】的申请吗？`, '提示', {
          ...
          Api.deleteInsurnaceApplication(params).then((res) => {
      ...
      onSubmit(){
        ...
        Api.submitInsuranceApplication(params).then(res=>{
           
            this.$message({
            showClose:true,
            message:'出险记录审批申请提交成功!',
            type:'success'
          })
      ...
      loadData (pageNum=1) {
        ...
        const fn = flag ==='details' ? 'getInsurnaceApplicationByApprovalId':'getInsurnaceApplication'
      ...
      newPayApply: function () {
        this.$router.push({path: '/router/addInsuranceRecordApplication'})
      },
