  ...
  <div>
    <el-form label-position="right" :model="form" :rules="rules" ref="form" label-width="150px">
      ...
      <span style="float: right; color: #8492a6; font-size: 13px">{{ item.projectCode }}</span>
          ...
          <el-row>
            <el-col :span="8">
              <el-form-item label="货值总金额(CNY)：" prop="goodsValue">
            ...
            <el-col :span="8">
             ...
             <el-col :span="8">
              <el-form-item label="净重：" prop="netWeight">
                <el-input v-model.trim="form.netWeight" style="width: 100%;"></el-input>
              </el-form-item>
            </el-col>
          </el-row>
          ...
          <el-row>
            <el-col :span="8">
              <el-form-item label="暂时进口期日：" prop="temporaryImportTerminalDate">
                <el-date-picker style="width: 100%"
                  v-model.trim="form.temporaryImportTerminalDate"
                  type="date"
            ...
            <el-col :span="8">
              <el-form-item label="进口延期次数：" prop="importDelayTime">
                <el-input v-model.trim="form.importDelayTime" style="width: 100%;"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="8">
              <el-form-item label="暂时进口编号：" prop="temporaryImportNo">
                <el-input v-model.trim="form.temporaryImportNo" style="width: 100%;"></el-input>
              </el-form-item>
            </el-col>
          </el-row>
          <el-row>
            <el-col :span="8">
              <el-form-item label="暂时出口到期日：" prop="temporaryExportTerminalDate">
                <el-date-picker style="width: 100%"
                                v-model.trim="form.temporaryExportTerminalDate"
                                type="date"
                                value-format="yyyy-MM-dd"
                                format="yyyy-MM-dd"
                                placeholder="暂时出口到期日">
            ...
            <el-col :span="8">
              <el-form-item label="出口延期次数：" prop="exportDelayTime">
                <el-input v-model.trim="form.exportDelayTime" style="width: 100%;"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="8">
              <el-form-item label="暂时出口编号：" prop="temporaryExportNo">
                <el-input v-model.trim="form.temporaryExportNo" style="width: 100%;"></el-input>
              </el-form-item>
            </el-col>
          </el-row>
          <el-row>
            <el-col :span="8">
              <el-form-item label="启运港：" prop="startPort">
          ...
          <el-row>
            <el-col :span="8">
              <el-form-item label="保费：" prop="insuranceAmount">
                <el-input v-model.trim="form.insuranceAmount" style="width: 100%;"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="8">
              <el-form-item label="暂时复出境报关号：" prop="temporaryComebackNo">
                <el-input v-model.trim="form.temporaryComebackNo" style="width: 100%;"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="8">
          ...
          <el-row>
            ...
            <el-col :span="8">
              <el-form-item label="提运单号：" prop="pickUpNo">
                <el-input v-model.trim="form.pickUpNo" style="width: 100%;"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="8">
              <el-form-item label="成交方式：" prop="tradeWay">
                <el-input v-model.trim="form.tradeWay" style="width: 100%;"></el-input>
              </el-form-item>
            </el-col>
          </el-row>
          ...
          <el-row>
            <el-col :span="8">
              <el-form-item label="预计录入编号：" prop="planRecordNo">
                <el-input v-model.trim="form.planRecordNo" style="width: 100%;"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="8">
              <el-form-item label="许可证号：" prop="licenseNumber">
                <el-input v-model.trim="form.licenseNumber" style="width: 100%;"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="8">
          ...
          <el-row>
            <el-col :span="8">
              <el-form-item label="包装类型：" prop="packageType">
                <el-input v-model.trim="form.packageType" style="width: 100%;"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="8">
              <el-form-item label="附件单证编号：" prop="attachmentDocNo">
                <el-input v-model.trim="form.attachmentDocNo" style="width: 100%;"></el-input>
              </el-form-item>
            </el-col>
          ...
          <el-row>
            <el-col :span="8">
              <el-form-item label="运费：" prop="transportFee">
                <el-input v-model.trim="form.transportFee" style="width: 100%;"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="8">
              <el-form-item label="杂费：" prop="otherFee">
                <el-input v-model.trim="form.otherFee" style="width: 100%;"></el-input>
              </el-form-item>
            </el-col>
          </el-row>
          <el-row>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      getSumGoodsInfo(){
          const customsGoodsReqs = this.form.customsGoodsReqs
          if(customsGoodsReqs.length>0){
            let  price = 0,sumPrices  = 0,monetary='';
             
              customsGoodsReqs.forEach(item=>{
                  if(item.unitOrTotalPrice && item.unitOrTotalPrice.indexOf('/')!=-1){
                      const unitOrTotalPrice = item.unitOrTotalPrice.split('/');
                      price+= parseFloat(unitOrTotalPrice[0].trim())
                      sumPrices+= parseFloat(unitOrTotalPrice[1].trim())
                      monetary=unitOrTotalPrice[2]
                  }
              })
              this.sumGoodsInfo = {
                price:price,
      ...
      load(){
        if(this.$route.query.id){
          ...
          let _this = this
          Api.customsManageDetail({id : this.$route.query.id}).then((res) => {
            if (res) {
              this.form = res
              ...
              this.form.temporaryExportTerminalDate = this.form.temporaryExportTerminalDate ? moment(res.temporaryExportTerminalDate).format('YYYY-MM-DD') : ''
              this.form.temporaryImportTerminalDate = res.temporaryImportTerminalDate ? moment(res.temporaryImportTerminalDate).format('YYYY-MM-DD') : ''
      ...
      /**返回*/
      backList(){
        this.$router.push({path: '/router/customsManage'})
      },
      ...
      //添加
      add: function (i) {
        Api.customsManageAdd(this.form).then(data => {
          if (data) {
            this.$notify.success({
              title: '提示',
              message: '添加成功'
      ...
      edit: function () {
        ...
        delete this.form['taxInsurePapers']
        Api.customsManageEdit(this.form).then(data => {
          if (data) {
            this.$notify.success({
              title: '提示',
              message: '修改成功'
