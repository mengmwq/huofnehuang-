  ...
  <div>
    ...
    <el-row class="m10">
      ...
      <el-col :span="20" class="text-right" style="float: right">
        预计完成时间：<el-date-picker style="width: 200px" v-model="query.date"  size="medium"
                               value-format="yyyy-MM-dd" format="yyyy-MM-dd" type="date"></el-date-picker>
        <el-select filterable v-model="query.type" clearable placeholder="任务类型" size="medium" @change="loadData" style="width:150px">
        ...
        <el-select filterable v-model="query.states" clearable placeholder="任务状态" size="medium" @change="loadData" style="width:150px">
    ...
    >
      ...
      <el-table-column label="操作" width="250" fixed="right">
        <template slot-scope="scope">
          ...
          <!--<el-button type="primary" size="small" @click="">拒绝</el-button>-->
      ...
      <div>
        <el-form :model="assignForm" ref="assignForm" label-width="130px">
            ...
            <el-form-item label="指派负责人：">
              <el-select filterable v-model="assignForm.directorId" clearable placeholder="请选择指派负责人" size="medium" style="width: 100%;">
          ...
          <el-row>
            ...
            <el-col :span="6">
              <el-form-item label="币种：">
                <el-select filterable v-model="form.currency" clearable placeholder="请选择币种" size="medium" style="width: 100%;">
...
<script>
  ...
  import FileSubmitTable from './FileSubmitTable'
